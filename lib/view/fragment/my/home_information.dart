            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  controller: name = new TextEditingController.fromValue(
                      TextEditingValue(
                          // 设置内容
                          text: names,
                          // 保持光标在最后
                ...
                Text(
                  user.counter.rows.merchant == 0 ? "性别" : "简介",
                  style: TextStyle(fontSize: ScreenUtil().setSp(36)),
                ),
                TextField(
                  keyboardType: TextInputType.text,
                  decoration: InputDecoration(
                    ...
                    icon: Icon(Icons.text_fields),
                    hintText:
                        user.counter.rows.merchant == 0 ? "请输入性别" : "请输入简介",
                  ),
                  controller: gender = new TextEditingController.fromValue(
                      TextEditingValue(
                          // 设置内容
                          text: genders,
                          // 保持光标在最后
                ...
                Text(
                  user.counter.rows.merchant == 0 ? "头像地址" : "Logo地址",
                  style: TextStyle(fontSize: ScreenUtil().setSp(36)),
                ),
                TextField(
                  keyboardType: TextInputType.text,
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.all(10.0),
                    icon: Icon(Icons.text_fields),
                    hintText: user.counter.rows.merchant == 0
                        ? "请输入头像地址"
                        : "请输入Logo地址",
                  ),
                  controller: heads = new TextEditingController.fromValue(
                      TextEditingValue(
                          // 设置内容
                          text: head,
                          // 保持光标在最后
                ...
                TextField(
                  ...
                  controller: phone = new TextEditingController.fromValue(
                      TextEditingValue(
                          // 设置内容
                          text: phones,
                          // 保持光标在最后
